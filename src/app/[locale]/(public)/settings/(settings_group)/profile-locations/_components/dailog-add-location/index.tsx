...
import CitySelectField from "./_components/city-select-field";
import AreaSelectField from "./_components/area-select-field";
import { useTranslations } from "next-intl";



const DailogAddLocation = () => {
  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button variant="default" className="md:w-1/2 w-full mt-8">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <Input {...field} placeholder={t("house_number_label")} />
                        <FormMessage />
                      </FormItem>
                    )}
                  />
